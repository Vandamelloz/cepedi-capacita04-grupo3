...
async def relatorio_manutencoes(formato: str = "csv", usuario_logado: dict = Depends(obter_usuario_atual)):
...
async def relatorio_reservas(formato: str = "csv", usuario_logado: dict = Depends(obter_usuario_atual)):
